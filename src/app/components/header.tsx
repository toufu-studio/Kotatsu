...
export default function Header({ isOpen, setIsOpen}: { isOpen: boolean;setIsOpen: (value:boolean) => void;}) {
    ...
    return (
        <header className="sticky shrink-0 top-0 h-20 border-b justify-between md:justify-center gap-10 border-gray-200 flex items-center bg-white/50 shadow-[0_1px_4px_rgba(0,0,0,0.05)] backdrop-blur-md">
