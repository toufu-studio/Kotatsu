...
export default function Profile() {
    ...
    return (
        <div className="flex flex-col md:min-h-screen bg-gray-50">

            <div className="w-full md:w-[690px] bg-background text-foreground min-h-screen mx-10 my-8 px-10 py-8 rounded-xl shadow-[0px_0px_20px_0.1px_rgba(0,3,3,0.03)]">
