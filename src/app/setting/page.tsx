...
export default function Profile() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-secondbg">
            ...
            <div className="w-full md:w-[690px] bg-background text-foreground h-150 mx-10 my-8 px-10 py-8 rounded-xl shadow-[0px_0px_20px_0.1px_rgba(0,3,3,0.05)]">
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex flex-col gap-5 mt-100 mb-10 md:mt-0">
                        <h2 className="text-xl font-bold">Theme Color</h2>
                        <div className="flex flex-wrap gap-5">
                            <button onClick={() => colorChange("rgb(249, 250, 251)")} className="bg-[rgb(249,250,251)] h-15 w-15 text-black rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">標準</span></button>
                            <button onClick={() => colorChange("rgb(235, 246, 247)")} className="bg-[rgb(235,246,247)] h-15 w-15 text-black rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">藍白</span></button>
                            <button onClick={() => colorChange("rgb(234, 244, 252)")} className="bg-[rgb(234,244,252)] h-15 w-15 text-black rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">月白</span></button>
                            <button onClick={() => colorChange("rgb(193, 228, 233)")} className="bg-[rgb(193,228,233)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">白藍</span></button>
                            <button onClick={() => colorChange("rgb(219, 208, 230)")} className="bg-[rgb(219,208,230)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">白藤</span></button>
                            <button onClick={() => colorChange("rgb(187, 200, 230)")} className="bg-[rgb(187,200,230)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">淡藤</span></button>
                            <button onClick={() => colorChange("rgb(192, 162, 199)")} className="bg-[rgb(192,162,199)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">薄葡萄</span></button>
                            <button onClick={() => colorChange("rgb(185, 208, 139)")} className="bg-[rgb(185,208,139)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">若葉</span></button>
                            <button onClick={() => colorChange("rgb(190, 211, 202)")} className="bg-[rgb(190,211,202)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">千草鼠</span></button>
                            <button onClick={() => colorChange("rgb(166, 200, 178)")} className="bg-[rgb(166,200,178)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">錆青磁</span></button>
                            <button onClick={() => colorChange("rgb(246, 173, 73)")} className="bg-[rgb(246,173,73)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">柑子</span></button>
                            <button onClick={() => colorChange("rgb(201, 117, 134)")} className="bg-[rgb(201,117,134)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">長春</span></button>
                            <button onClick={() => colorChange("rgb(241, 144, 114)")} className="bg-[rgb(241,144,114)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">東雲</span></button>
                            <button onClick={() => colorChange("rgb(165, 149, 100)")} className="bg-[rgb(165,149,100)] h-15 w-15 text-white rounded-xl cursor-pointer flex justify-center items-center relative group hover:-translate-y-1 ease-out transition-transform"><span className="absolute opacity-0 group-hover:opacity-100 transition-opacity ease-out w-15">利休茶</span></button>
                        </div>
                    </div>
                    <div className="flex flex-col gap-5 mt-100 md:mt-0">
